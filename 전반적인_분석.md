...
- IOS Native Pro
    ...
    코드상 사용중이지만 프로젝트에 미포함 되어 있음. 대체 또는 구입 필요.
    ios상 게임 세이브. 랭킹 표시 등에 필요함
...
# 4. 광고 위치
광고 위치 리스트 [문서로](https://github.com/Bo-sung/BBF_-/blob/master/리스트/광고_위치_리스트.md)

*****

# 5. 판매 상품

판매 상품 리스트[문서로](https://github.com/Bo-sung/BBF_-/blob/master/리스트/판매_상품_리스트.md)
...
# 7. 질문사항 
질문사항 리스트 [문서로](https://github.com/Bo-sung/BBF_-/blob/master/리스트/질문사항_리스트.md)
